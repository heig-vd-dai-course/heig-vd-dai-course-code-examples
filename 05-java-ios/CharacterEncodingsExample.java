 ...
 */
public class CharacterEncodingsExample {

  public static void main(String[] args) throws IOException {
    CharacterEncodingsExample main = new CharacterEncodingsExample();
  ...
  private void encodeAndDecode(String message, Charset encoding) {
    ...
    System.out.println(
      "If I decode the result with the same encoding (" +
      encoding +
      "), I get: " +
      decodedMessage
    );
    ...
    System.out.println(
      "If I decode the result with the default encoding (UTF-8), I get: " +
      utf8DecodedMessage
    );
    ...
    // System.out.println(STR."If I decode the result with the default encoding for this JVM (" + System.getProperty("file.encoding") + "), I get: ");
    // System.out.println();
  }
}
